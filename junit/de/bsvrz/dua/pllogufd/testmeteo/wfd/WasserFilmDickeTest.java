...
extends MeteorologischeKontrolleTest {
	...
	public final void testRegel1(){
		...
		this.sendeFehlerhaftDaten(fbzSensoren, zeitStempel - PlPruefungLogischUFDTest.STANDARD_T);
	...
	public final void testRegel3(){
		...
		this.sendeFehlerhaftDaten(niSensoren, zeitStempel - PlPruefungLogischUFDTest.STANDARD_T);
		this.sendeFehlerhaftDaten(rlfSensoren, zeitStempel - PlPruefungLogischUFDTest.STANDARD_T);
		this.sendeFehlerhaftDaten(restSensoren, zeitStempel - PlPruefungLogischUFDTest.STANDARD_T);

 ...
 */
public class TestWfdFbzImplausibleWeiterleitung extends DuAPlLogUfdTestBase {
	...
	protected String[] getUfdArgs() {
		return new String[]{"-KonfigurationsBereichsPid=kb.duaTestUfd", "-useWfdTrockenGrenzwert=true", "-fehlerhafteWertePublizieren=true"};
	}
	...
	public void testImplausibleWeiterleitung() throws Exception {
		...
		startTestCase("WFD_FBZ_Implausible_Sent.csv", send, rec, new Dua58Layout());
	}

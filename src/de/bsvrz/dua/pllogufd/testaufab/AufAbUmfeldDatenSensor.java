 ...
 * bzgl. der Anstieg-Abfall-Kontrolle
 * 
 * @author BitCtrl Systems GmbH, Thierfelder
 *
 */
public class AufAbUmfeldDatenSensor
extends AbstraktUmfeldDatenSensor{
	...
	throws DUAInitialisierungsException{
		...
		if(atg != null){
			...
			throw new DUAInitialisierungsException("Es konnte keine Parameter-Attributgruppe für die " + //$NON-NLS-1$
					"Anstieg-Abfall-Kontrolle des Objektes " + this.objekt + " bestimmt werden\n" +  //$NON-NLS-1$//$NON-NLS-2$ 
	...
	/**
	 * Hier findet die Prüfung eines Datums statt. Diese findet nur für den Fall statt,
